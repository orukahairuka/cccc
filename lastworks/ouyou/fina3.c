/*****
作品の説明は必須、その他必要に応じて、操作方法、工夫した点

2353702 情報理工学部 情報理工学科 1年 櫻井 絵理香

・作品の説明と操作方法
街の風景を描写した。ターミナル上で"aかbを入力してください"と表示された時に
'a'か'b'のキーを押してください。
'a'の時には車がどんどん早く走るアニメーションが流れます。
'b'の時には大雪が降るアニメーションが流れます。
'a'と'b'の両方のアニメーションを見てくれると嬉しいです。

・工夫した点
雪が自然に降っている感じに見せるため頑張りました。あと変数の計算を頑張りました。
変数がとても多く、適切でわかりやすい名前をつけました。背景にこだわりました。
        ...
        //sound = HgSoundLoad("car_se.mp3");
            ...
            for (;;) {
               ...
               /*hgsound sound;
                ...
                /*hgsound HgSoundWithName("car_se.mp3");*/
